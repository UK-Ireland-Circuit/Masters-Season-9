...
| Group Stage | 8 Qualified | 2x GSL Double Elimination BO3 Matches | 4 Teams advance to next stage |
| Play-Off | 4 Qualified | Single Elimination<br>BO3 Matches | 2 Teams advance to LAN Finals |
...
Each team is permitted to register two (2) stand-in players for the event. The team coach may also serve as a stand-in, subject to all applicable rules outlined herein.
...
**Round Restore / Match Medic**

Players can initiate an in-game round restore using the **!restore** / **.restore** chat commands only if the following round conditions are met:

- The match is not paused (e.g. is Live, not freeze time)
- Before 15 seconds have passed after round start & no player has taken damage & no utility has been thrown

Each team has 3 round restores available throughout the entire match. If further assistance is required please use your tech pause and contact an admin via discord.
...
Example: If a team wishes to reschedule a game default set to July 22, 2025 20:30 they will only be able to play during the following time frame: July 21, 2025 → July 27, 2025 

Playoffs matches can be rescheduled from when the match is available (i.e. the previous round has been played for both teams) up until 24 hours before the scheduled next round.

If a team wishes to reschedule a game they must submit the request at least 24 hours before the already scheduled match start time.

If an opponent hasn't replied within 24 hours of being contacted for a reschedule, the reschedule request will be automatically put through.
...
- Once the round has ended and the Technical Pause has started the affected player / team must follow [4.2.10 Technical Issues](https://www.notion.so/Rulebook-2648b29a95c48185babed146c5e3ea0f?pvs=21)
- If the opposition team believes the “Not Live” has been called outside the scope of [4.2.11 Match Interruptions](https://www.notion.so/Rulebook-2648b29a95c48185babed146c5e3ea0f?pvs=21) they can continue to play the round as normal and contest the “Not Live” with an Admin during the Tech Pause
